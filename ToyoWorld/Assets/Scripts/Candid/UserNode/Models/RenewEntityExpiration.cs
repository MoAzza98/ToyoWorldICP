...
{
	public class RenewEntityExpiration
	{
		[CandidName("duration")]
		...
		public RenewEntityExpiration(duration duration, entityId eid, groupId gid, OptionalValue<worldId> wid)
		{
